...
ModLoader.SetupFileHook( "lua/Weapons/Alien/Gore.lua", "lua/Weapons/Alien/Gore_Avoca.lua", "post" )
...
ModLoader.SetupFileHook( "lua/Weapons/Marine/Rifle.lua", "lua/Weapons/Marine/Rifle_Avoca.lua", "post" )

ModLoader.SetupFileHook( "lua/Weapons/Marine/Pistol.lua", "lua/Weapons/Marine/Pistol_Avoca.lua", "post" )
