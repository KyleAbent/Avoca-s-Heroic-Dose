...
--overwriting to try adjusting visual aim help
...
local function UpdateTargets(self)
    ...
    */
    ...
    for t = 1, #trackEntities do
        ...
        if inFront and trackEntity:GetIsAlive() and trackEntity:isa("Alien") and not trackEntity:GetIsCloaked() then --from skulk to alien
