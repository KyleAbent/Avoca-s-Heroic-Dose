...
Shine.VoteMenu:AddPage ("FastGestation", function( self )
		self:AddSideButton("Gorge: "..(gCreditClassCostGorge*kPresToClassesMult)*2, function() Shared.ConsoleCommand ("sh_buyclass Gorge salt fast")  end)
		self:AddSideButton("Lerk: "..(gCreditClassCostLerk*kPresToClassesMult)*2, function() Shared.ConsoleCommand ("sh_buyclass Lerk salt fast")  end)
		self:AddSideButton("Fade: "..(gCreditClassCostFade*kPresToClassesMult)*2, function() Shared.ConsoleCommand ("sh_buyclass Fade salt fast")  end)
        self:AddSideButton("Onos: "..(gCreditClassCostOnos*kPresToClassesMult)*2, function() Shared.ConsoleCommand ("sh_buyclass Onos salt fast") end)
