...
Shine:NotifyDualColour( Player, 255, 165, 0,  "[9.8.17 MapStats]",  255, 0, 0, String, Format, ... )
end
...
Shine:NotifyDualColour( Player, 255, 165, 0,  "[9.8.17 MapStats]",  math.random(0,255), math.random(0,255), math.random(0,255), String, Format, ... )
end
